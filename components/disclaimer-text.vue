<template>
  <div>
    <p>
      ...
      built from the daily repos. They are not human-tested and may contain major
      issues. <strong>It will not be possible to upgrade</strong> to the stable
      release from these builds.
    </p>

    <p>
      <strong>Do not use daily builds on a production system</strong>.
    </p>
